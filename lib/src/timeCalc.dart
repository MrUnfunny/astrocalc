...
double getDeltaT(int year, int month) {
  ...
  if (year < -500) {
    ...
    return 120 -
        0.9808 * (y - 1600) -
        0.01532 * pow((y - 1600), 2) +
        pow((y - 1600), 3) / 7129 +
        lunarCorrection;
  } else if (year >= 1700 && year < 1800) {
    return 8.83 +
        0.1603 * (y - 1700) -
        0.0059285 * pow((y - 1700), 2) +
        0.00013336 * pow((y - 1700), 3) -
        pow((y - 1700), 4) / 1174000 +
        lunarCorrection;
    ...
    return 7.62 +
        0.5737 * (y - 1860) -
        0.251754 * pow((y - 1860), 2) +
        0.01680668 * pow((y - 1860), 3) -
        0.0004473624 * pow((y - 1860), 4) +
        pow((y - 1860), 5) / 233174 +
        lunarCorrection;
  } else if (year >= 1900 && year < 1920) {
    return -2.79 +
        1.494119 * (y - 1900) -
        0.0598939 * pow((y - 1900), 2) +
        0.0061966 * pow((y - 1900), 3) -
        0.000197 * pow((y - 1900), 4) +
        lunarCorrection;
  } else if (year >= 1920 && year < 1941) {
    return 21.20 +
        0.84493 * (y - 1920) -
        0.076100 * pow((y - 1920), 2) +
        0.0020936 * pow((y - 1920), 3) +
        lunarCorrection;
    ...
    return 63.86 +
        0.3345 * (y - 2000) -
        0.060374 * pow((y - 2000), 2) +
        0.0017275 * pow((y - 2000), 3) +
        0.000651814 * pow((y - 2000), 4) +
        0.00002373599 * pow((y - 2000), 5);
  } else if (year >= 2005 && year < 2050) {
    return 62.92 +
        0.32217 * (y - 2000) +
        0.005589 * pow((y - 2000), 2) +
        lunarCorrection;
